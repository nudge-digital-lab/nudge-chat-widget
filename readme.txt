...
= 1.3.1 =
* Fix: reemplazado el uso de heredoc (no permitido por las guidelines de WordPress.org) por strings estándar.

= 1.3.0 =
* Flujo por defecto reorientado a "hablar con un asesor": motivo de consulta, horario de contacto y urgencia, en vez de preguntas de proyecto web. Sirve para cualquier rubro (automotor, retail, servicios, etc), no solo agencias digitales.
